...
export const UnderControl = () => {
	...
	return (
		<>
			...
			<Overlay visible={visible} onVisibleChange={(v) => setVisible(v)} target={() => buttonRef.current!}>
				<div
					style={{
						border: '1px solid black',
						width: 300,
...
export const Points = () => {
	...
	return (
		<>
			...
			<Overlay visible={visible} onVisibleChange={(v) => setVisible(v)} target={() => buttonRef.current!} points={['tl', 'tl']}>
				<div
					style={{
						border: '1px solid black',
						width: 300,
