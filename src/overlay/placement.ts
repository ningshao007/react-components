...
export default function getPlacement({ target, overlay, placement, points: opoints = ['tl', 'bl'] as PointsType, beforePosition }: placementConfig) {
	if (!target || !overlay) {
		return {};
	}
