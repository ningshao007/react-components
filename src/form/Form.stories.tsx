	...
	return (
		<Form name='basic' labelCol={{ span: 8 }} wrapperCol={{ span: 16 }} initialValues={{ remember: true }} onFinish={onFinish} onFinishFailed={onFinishFailed}>
			...
			{/* <Form.Item name='remember' valuePropName='checked'>
				<Checkbox checked={checked} value='checkvalue' onChange={(e) => setChecked(e.target.checked)}>
					Remember me
				</Checkbox>
			</Form.Item> */}

			<Form.Item name='name111'>
...
export const Basic: React.FC = () => {
	...
	return (
		<Form name='basic' labelCol={{ span: 8 }} wrapperCol={{ span: 16 }} initialValues={{ remember: true, username: 'Jack' }} onFinish={onFinish} onFinishFailed={onFinishFailed}>
			<Form.Item
				label='Username'
				name='username'
				rules={[
			...
			<Form.Item name='name222'>
				<>
					...
					<Reset style={{ marginLeft: 8 }} resetValue={{ password: '123456' }}>
						fill Value
					</Reset>
				</>
			</Form.Item>
